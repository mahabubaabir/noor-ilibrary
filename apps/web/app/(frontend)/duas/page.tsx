      ...
      <div className="relative mb-8 overflow-hidden rounded-3xl border border-neutral-200 bg-neutral-50 p-6 sm:p-10 backdrop-blur-xl dark:border-neutral-800 dark:bg-neutral-900">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/hisnul-muslim"
              className="inline-flex items-center gap-2 rounded-2xl border border-neutral-300 bg-white px-4 py-2.5 text-xs font-bold text-neutral-900 shadow-sm hover:bg-neutral-100 dark:border-neutral-700 dark:bg-neutral-950 dark:text-white dark:hover:bg-neutral-900 transition-all"
            >
      ...
      <div className="space-y-6">
        {filteredDuas.map((dua) => {
          ...
          return (
            <div
              key={dua.id}
              className="group relative rounded-3xl border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-800 dark:bg-neutral-950 transition-all duration-200 hover:shadow-lg sm:p-8"
            >
              {/* Card Header */}
              <div className="flex flex-wrap items-center justify-between gap-3 border-b border-neutral-200 dark:border-neutral-800 pb-4">
                <div className="flex items-center gap-2">
                  <span className="rounded-xl bg-neutral-100 px-3 py-1 text-xs font-bold text-neutral-900 dark:bg-neutral-800 dark:text-white">
                    {dua.categoryLabelBn}
                  </span>
                  {dua.recommendedCount && (
                    <span className="rounded-xl border border-neutral-200 px-2.5 py-1 text-[11px] font-bold text-neutral-600 dark:border-neutral-800 dark:text-neutral-400">
              ...
              <div className="mt-4">
                ...
                <div className="my-5 rounded-2xl bg-neutral-50 border border-neutral-200 p-5 text-center dark:bg-neutral-900 dark:border-neutral-800 sm:p-7">
                ...
                <div className="space-y-3 text-xs sm:text-sm">
                  ...
                  <div className="rounded-2xl border border-neutral-200 bg-white p-4 dark:border-neutral-800 dark:bg-neutral-950">
                    <p className="leading-relaxed text-neutral-800 dark:text-neutral-200">
                      <span className="font-bold text-neutral-900 dark:text-white">বাংলা অর্থ:</span> {dua.translationBn}
                    </p>
                  </div>
                </div>

                {/* Benefits & References */}
                <div className="mt-4 flex flex-col gap-2 rounded-2xl border border-neutral-200 bg-neutral-50 p-4 text-xs dark:border-neutral-800 dark:bg-neutral-900 sm:flex-row sm:items-center sm:justify-between">
                  <p className="text-neutral-700 dark:text-neutral-300">
                    <span className="font-bold text-neutral-900 dark:text-white">ফজিলত ও আমল:</span> {dua.benefitBn}
                  </p>
