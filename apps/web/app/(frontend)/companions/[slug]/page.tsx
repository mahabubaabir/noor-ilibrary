...
export default function CompanionDetailPage({ params }: PageProps) {
  ...
  const themeContainerClass = {
    ...
    night: "bg-neutral-950 text-neutral-100 border-neutral-800",
  }[readerTheme]
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6">
      ...
      <div className="mb-6 flex flex-wrap items-center justify-between gap-3 border-b border-neutral-200/60 pb-4 dark:border-neutral-800/60">
        <Link
          href="/companions"
          className="inline-flex items-center gap-1.5 text-xs font-bold text-neutral-600 hover:text-neutral-600 dark:text-neutral-400 dark:hover:text-neutral-400"
        >
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <div className="flex rounded-xl bg-neutral-100 p-1 dark:bg-neutral-800">
            <button
              ...
              className={`rounded-lg px-2.5 py-1 text-xs font-bold transition-all ${
                lang === "bn"
                  ? "bg-white text-neutral-700 shadow-sm dark:bg-neutral-700 dark:text-neutral-300"
          ...
          <div className="flex items-center rounded-xl bg-neutral-100 p-1 dark:bg-neutral-800">
            <button
              ...
              className={`rounded-lg px-2 py-1 text-[11px] font-bold ${
                fontSize === "sm" ? "bg-white shadow-sm dark:bg-neutral-700" : "text-neutral-500"
              }`}
            >
              A-
            </button>
            <button
              ...
              className={`rounded-lg px-2 py-1 text-xs font-bold ${
                fontSize === "base" ? "bg-white shadow-sm dark:bg-neutral-700" : "text-neutral-500"
              }`}
            >
              A
            </button>
            <button
              ...
              className={`rounded-lg px-2 py-1 text-xs font-bold ${
                fontSize === "lg" ? "bg-white shadow-sm dark:bg-neutral-700" : "text-neutral-500"
              }`}
            >
              A+
            </button>
          ...
          <div className="flex rounded-xl bg-neutral-100 p-1 dark:bg-neutral-800">
            <button
              ...
              className={`rounded-lg p-1.5 text-xs ${
                readerTheme === "default" ? "bg-white shadow-sm dark:bg-neutral-700" : "text-neutral-500"
              }`}
              title="ডিফল্ট মোড"
            >
            ...
            <button
              ...
              className={`rounded-lg p-1.5 text-xs ${
                readerTheme === "sepia" ? "bg-neutral-100 text-neutral-900 shadow-sm" : "text-neutral-500"
              }`}
            ...
            <button
              ...
              className={`rounded-lg p-1.5 text-xs ${
                readerTheme === "night" ? "bg-neutral-900 text-white shadow-sm" : "text-neutral-500"
              }`}
          ...
          <LikeButton
            ...
            className={`rounded-xl p-2 transition-colors ${
              bookmarked
                ? "bg-neutral-50 text-neutral-600 dark:bg-neutral-950/60"
          ...
          <button
            onClick={handleShare}
            className="rounded-xl p-2 text-neutral-400 hover:bg-neutral-100 hover:text-neutral-700 dark:hover:bg-neutral-800"
          >
            {copied ? <Check className="h-4 w-4 text-neutral-600" /> : <Share2 className="h-4 w-4" />}
          </button>
        </div>
      </div>
      ...
      {selectedText && (
        <div className="fixed bottom-6 right-6 z-50 flex max-w-sm flex-col gap-2 rounded-2xl border border-neutral-500/30 bg-white p-4 shadow-2xl backdrop-blur-xl dark:bg-neutral-900 sm:bottom-10 sm:right-10">
          <div className="flex items-center justify-between text-xs font-bold text-neutral-700 dark:text-neutral-400">
          ...
          {isAddingNote ? (
            <div className="space-y-2">
              <textarea
                ...
                className="w-full rounded-xl border border-neutral-200 bg-neutral-50 p-2 text-xs focus:border-neutral-500 focus:outline-none dark:border-neutral-800 dark:bg-neutral-800"
                rows={2}
              />
      ...
      >
        {/* Article Header */}
        <div className="mb-8 border-b border-neutral-200/50 pb-6 text-center dark:border-neutral-800/50">
          <span className="inline-block rounded-xl bg-neutral-100 px-3.5 py-1 text-xs font-bold text-neutral-800 dark:bg-neutral-950/60 dark:text-neutral-300">
            {lang === "bn" ? companion.categoryLabelBn : companion.categoryLabelEn} • {companion.era}
          </span>

          <p className="arabic mt-4 text-3xl font-bold text-neutral-900 dark:text-neutral-100 sm:text-4xl" dir="rtl">
          ...
          <p className="mt-2 text-sm font-semibold text-neutral-700 dark:text-neutral-400">
            {lang === "bn" ? companion.titleBn : companion.titleEn}
          </p>

          <p className="mx-auto mt-4 max-w-2xl text-xs sm:text-sm leading-relaxed text-neutral-600 dark:text-neutral-300">
            {lang === "bn" ? companion.shortBioBn : companion.shortBioEn}
          </p>
        </div>

        {/* Key Attributes Pills */}
        <div className="mb-8 rounded-2xl bg-neutral-50/50 p-4 dark:bg-neutral-950/20">
          <h3 className="text-xs font-bold uppercase tracking-wider text-neutral-900 dark:text-neutral-200 mb-2 flex items-center gap-1.5">
          ...
          {sections.map((section, idx) => (
            <div key={idx} className="space-y-3">
              <h2 className="text-lg sm:text-xl font-bold text-neutral-900 dark:text-neutral-100 flex items-center gap-2">
                <span className="flex h-6 w-6 items-center justify-center rounded-lg bg-neutral-600 text-xs font-bold text-white">
                  {idx + 1}
                </span>
                {section.heading}
              </h2>
              ...
              {section.hadithOrQuoteRef && (
                <div className="rounded-2xl border-l-4 border-neutral-500 bg-neutral-50/80 p-4 text-xs italic dark:bg-neutral-800/60">
                  <span className="font-bold not-italic text-neutral-700 dark:text-neutral-400">
                    সনদ ও উদ্ধৃতি:
                  </span>{" "}
                  {section.hadithOrQuoteRef}
                </div>
        ...
        <div className="mt-10 rounded-3xl border border-neutral-500/30 bg-neutral-50/60 p-6 dark:border-neutral-500/30 dark:bg-neutral-950/20 sm:p-8">
          <h3 className="text-base font-bold text-neutral-900 dark:text-neutral-200 flex items-center gap-2 mb-3">
            <Sparkles className="h-5 w-5 text-neutral-600" />
            {lang === "bn" ? "আমাদের দৈনন্দিন জীবনের শিক্ষা" : "Practical Lessons for Daily Life"}
          </h3>
          <ul className="space-y-2 text-xs sm:text-sm text-neutral-800 dark:text-neutral-200 list-disc pl-5 leading-relaxed">
        ...
        {highlights.length > 0 && (
          <div className="mt-10 rounded-3xl border border-neutral-200 bg-neutral-50/70 p-6 dark:border-neutral-800 dark:bg-neutral-800/40">
            ...
            <div className="space-y-3">
              {highlights.map((h) => (
                <div
                  key={h.id}
                  className="flex items-start justify-between gap-3 rounded-2xl bg-white p-3.5 shadow-sm dark:bg-neutral-900"
                >
          ...
          {COMPANIONS_COLLECTION.filter((c) => c.id !== companion.id)
            ...
            .map((c) => (
              <Link
                ...
                className="group rounded-2xl border border-neutral-200/80 bg-white p-4 transition-all hover:border-neutral-400 hover:shadow-md dark:border-neutral-800 dark:bg-neutral-900"
              >
                <span className="text-[11px] font-bold text-neutral-600 dark:text-neutral-400">
                  {c.categoryLabelBn}
                </span>
                <h4 className="mt-1 text-sm font-bold text-neutral-900 group-hover:text-neutral-700 dark:text-neutral-100 dark:group-hover:text-neutral-400">
                  {c.nameBn}
                </h4>
